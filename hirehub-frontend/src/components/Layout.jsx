          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-3 tracking-widest uppercase flex items-center">
                <span className="font-orbitron text-white">HIRE</span>
                <span className="font-orbitron text-neon-cyan drop-shadow-[0_0_8px_rgba(0,240,255,0.8)]">HUB</span>
            ...
            <div>
              ...
              <div className="group inline-flex items-center space-x-2">
                ...
                <p className="text-sm group-hover:text-slate-300 transition-colors">support@hirehub.com</p>
              </div>
            </div>
          </div>
          <div className="border-t border-white/10 mt-10 pt-8 text-center text-sm text-slate-500 font-mono">
            <p>&copy; {new Date().getFullYear()} <span className="text-neon-cyan">HireHub</span> // All systems operational. Latency: <span className="text-neon-green animate-pulse">12ms</span></p>
          </div>
        </div>
      </footer>
    </div>
